...
- :bookmark: latest release: version 3.9.2, Wed 6 May 2020.
...
## Download version 3.9.2

[Download](https://gitlab.com/basile.b/dexed/-/releases/v3.9.2) the zipped binaries or the zip that contains the setup program for you platform.

<!--
- :package: [setup program for Linux 64 bit](https://gitlab.com/basile.b/dexed/releases/v3.9.2/downloads/binaries/dexed.3.9.2.linux64.setup.zip)
- :package: [binaries for Linux 64 bit](https://gitlab.com/basile.b/dexed/releases/v3.9.2/downloads/binaries/dexed.3.9.2.linux64.zip)
- :package: [rpm for Linux 64 bit](https://gitlab.com/basile.b/dexed/releases/v3.9.2/downloads/binaries/dexed-3.9.2-0.x86_64.rpm)
- :package: [deb for Linux 64 bit](https://gitlab.com/basile.b/dexed/releases/v3.9.2/downloads/binaries/dexed-3.9.2.amd64.deb)
-->
